        ...
        class PageTransition {
          ...
          constructor() {
            ...
            this.filteredLinks = this.links.filter((link) => {
              ...
              return temp.hostname === window.location.host && !temp.href.includes("#") && link.target !== "_blank";
            });
          ...
          checkPage() {
            ...
            if (windowLocation === "/") {
              const tl = gsapWithCSS.timeline({
                onComplete: () => {
                  gsapWithCSS.set(this.transitionElement, { opacity: 1 });
                }
              });
      ...
      formHandler = () => {
        class FormHandler {
          ...
          constructor() {
            ...
            this.successElement = this.form.querySelector(".newsletter_success");
            this.errorElement = this.form.querySelector(".form_message-error");
          ...
          showSuccess() {
            gsapWithCSS.to(this.successElement, { display: "block" });
          }
          showError(msg) {
